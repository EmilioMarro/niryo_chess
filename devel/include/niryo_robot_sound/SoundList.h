...
struct SoundList_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::niryo_robot_sound::SoundObject_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::niryo_robot_sound::SoundObject_<ContainerAllocator> >::other >  _sounds_type;
  _sounds_type sounds;
