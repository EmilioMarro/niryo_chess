...
struct ConveyorFeedbackArray_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::conveyor_interface::ConveyorFeedback_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::conveyor_interface::ConveyorFeedback_<ContainerAllocator> >::other >  _conveyors_type;
