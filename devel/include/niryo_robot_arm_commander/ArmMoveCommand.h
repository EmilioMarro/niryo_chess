...
struct ArmMoveCommand_
{
  ...
  _shift_type shift;
   ...
   typedef std::vector< ::geometry_msgs::Pose_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::geometry_msgs::Pose_<ContainerAllocator> >::other >  _list_poses_type;
  ...
  _trajectory_type trajectory;
   ...
   typedef std::vector<double, typename ContainerAllocator::template rebind<double>::other >  _args_type;
  _args_type args;
...
struct MD5Sum< ::niryo_robot_arm_commander::ArmMoveCommand_<ContainerAllocator> >
{
  ...
  {
    return "1deb7e99b1acd8aa8624a78fecda3b70";
  }

  static const char* value(const ::niryo_robot_arm_commander::ArmMoveCommand_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x1deb7e99b1acd8aaULL;
  static const uint64_t static_value2 = 0x8624a78fecda3b70ULL;
};
