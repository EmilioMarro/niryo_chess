...
struct StepperArrayMotorHardwareStatus_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::can_driver::StepperMotorHardwareStatus_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::can_driver::StepperMotorHardwareStatus_<ContainerAllocator> >::other >  _motors_hw_status_type;
