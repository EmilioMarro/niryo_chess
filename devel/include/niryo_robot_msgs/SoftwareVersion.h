...
struct SoftwareVersion_
{
  ...
  _rpi_image_version_type rpi_image_version;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _ros_niryo_robot_version_type;
  _ros_niryo_robot_version_type ros_niryo_robot_version;

   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _robot_version_type;
...
struct Printer< ::niryo_robot_msgs::SoftwareVersion_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::niryo_robot_msgs::SoftwareVersion_<ContainerAllocator>& v)
  {
    ...
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.ros_niryo_robot_version);
    s << indent << "robot_version: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.robot_version);
