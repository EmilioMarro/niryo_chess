...
struct AnalogIOState_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::niryo_robot_rpi::AnalogIO_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::niryo_robot_rpi::AnalogIO_<ContainerAllocator> >::other >  _analog_inputs_type;
  _analog_inputs_type analog_inputs;

   typedef std::vector< ::niryo_robot_rpi::AnalogIO_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::niryo_robot_rpi::AnalogIO_<ContainerAllocator> >::other >  _analog_outputs_type;
