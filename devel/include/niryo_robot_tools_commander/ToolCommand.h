...
struct ToolCommand_
{
  ...
  _activate_type activate;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _gpio_type;
  _gpio_type gpio;
...
struct Printer< ::niryo_robot_tools_commander::ToolCommand_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::niryo_robot_tools_commander::ToolCommand_<ContainerAllocator>& v)
  {
    ...
    s << indent << "gpio: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.gpio);
  }
};
