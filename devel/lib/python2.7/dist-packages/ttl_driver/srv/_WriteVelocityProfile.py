...
class WriteVelocityProfileRequest(genpy.Message):
  _md5sum = "56f66e4e97f6b6302d16857c6e647e67"
...
"""
  ...
  _slot_types = ['uint8','uint32','uint32','uint32','uint32','uint32','uint32','uint32','uint32']
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_B8I().pack(_x.id, _x.v_start, _x.a_1, _x.v_1, _x.a_max, _x.v_max, _x.d_max, _x.d_1, _x.v_stop))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.id, _x.v_start, _x.a_1, _x.v_1, _x.a_max, _x.v_max, _x.d_max, _x.d_1, _x.v_stop,) = _get_struct_B8I().unpack(str[start:end])
      return self
...
def _get_struct_B8I():
    global _struct_B8I
    if _struct_B8I is None:
        _struct_B8I = struct.Struct("<B8I")
    return _struct_B8I
# This Python file uses the following encoding: utf-8
...
class WriteVelocityProfile(object):
  ...
  _md5sum = '7fdfbe3f89a784e9435cf0392f002920'
