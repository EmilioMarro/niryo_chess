...
"""autogenerated by genpy from niryo_robot_vision/ObjDetectionRequest.msg. Do not edit."""
import sys
...
class ObjDetectionRequest(genpy.Message):
  ...
  _type = "niryo_robot_vision/ObjDetectionRequest"
...
def _get_struct_fB():
    ...
    return _struct_fB
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from niryo_robot_vision/ObjDetectionResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class ObjDetectionResponse(genpy.Message):
  _md5sum = "8a9820b5b8f1b859d20928c611ac82a0"
  _type = "niryo_robot_vision/ObjDetectionResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  ...
  _slot_types = ['int32','niryo_robot_msgs/ObjectPose','string','string','sensor_msgs/CompressedImage']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.obj_pose is None:
        self.obj_pose = niryo_robot_msgs.msg.ObjectPose()
      if self.obj_type is None:
        self.obj_type = ''
      if self.obj_color is None:
        self.obj_color = ''
...
class ObjDetection(object):
  _type          = 'niryo_robot_vision/ObjDetection'
  _md5sum = '9e4efd6b216b3412a5d44ee05962fab9'
