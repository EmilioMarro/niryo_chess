...
"""autogenerated by genpy from niryo_robot_rpi/DigitalIOState.msg. Do not edit."""
import sys
...
class DigitalIOState(genpy.Message):
  ...
  _type = "niryo_robot_rpi/DigitalIOState"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """niryo_robot_rpi/DigitalIO[] digital_inputs
...
bool value"""
  ...
  _slot_types = ['niryo_robot_rpi/DigitalIO[]','niryo_robot_rpi/DigitalIO[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = niryo_robot_rpi.msg.DigitalIO()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
