...
class RobotStatus(genpy.Message):
  _md5sum = "152de064b015fa11a066c0802dddd673"
  _type = "niryo_robot_status/RobotStatus"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """int8 SHUTDOWN=-5
...
bool rpi_overheating"""
  ...
  def serialize(self, buff):
    ...
    """
    try:
      buff.write(_get_struct_b().pack(self.robot_status))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_b().pack(self.logs_status))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.robot_status_str = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.robot_message = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.logs_status_str = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.logs_message = str[start:end].decode('utf-8')
      else:
