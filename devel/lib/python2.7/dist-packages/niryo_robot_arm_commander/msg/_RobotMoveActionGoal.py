...
class RobotMoveActionGoal(genpy.Message):
  _md5sum = "e5d586e624fd2f0a496062f6e69752f5"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.goal.cmd.args))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.goal.cmd.trajectory.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      self.goal.cmd.args = struct.unpack(pattern, str[start:end])
      return self
